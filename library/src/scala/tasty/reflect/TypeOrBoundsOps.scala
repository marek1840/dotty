...
trait TypeOrBoundsOps extends Core {
  ...
  implicit class SuperTypeAPI(self: SuperType) {
  ...
  implicit class RefinementAPI(self: Refinement) {
  ...
  implicit class AppliedTypeAPI(self: AppliedType) {
  ...
  implicit class AnnotatedTypeAPI(self: AnnotatedType) {
  ...
  implicit class ByNameTypeAPI(self: ByNameType) {
    def underlying(implicit ctx: Context): Type = kernel.ByNameType_underlying(self)
  }

  implicit class ParamRefAPI(self: ParamRef) {
  ...
  implicit class PolyTypeAPI(self: PolyType) {
  ...
  implicit class TypeLambdaAPI(self: TypeLambda) {
